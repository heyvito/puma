...
#line 89 "ext/puma_http11/http11_parser.rl"
  ...
  parser->request = Qnil;
  parser->body = Qnil;
  parser->verbatim_headers_key = rb_str_new("puma.verbatim_headers", 21);
...
#line 88 "ext/puma_http11/http11_parser.c"
	{
	if ( p == pe )
		goto _test_eof;
	switch ( cs )
...
st2:
	if ( ++p == pe )
		goto _test_eof2;
case 2:
#line 119 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 32: goto tr2;
		case 36: goto st27;
		case 95: goto st27;
...
st3:
	if ( ++p == pe )
		goto _test_eof3;
case 3:
#line 144 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 42: goto tr4;
		case 43: goto tr5;
		case 47: goto tr6;
...
st4:
	if ( ++p == pe )
		goto _test_eof4;
case 4:
#line 168 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 32: goto tr8;
		case 35: goto tr9;
	}
...
st5:
	if ( ++p == pe )
		goto _test_eof5;
case 5:
#line 230 "ext/puma_http11/http11_parser.c"
	if ( (*p) == 72 )
		goto tr10;
	goto st0;
tr10:
...
st6:
	if ( ++p == pe )
		goto _test_eof6;
case 6:
#line 242 "ext/puma_http11/http11_parser.c"
	if ( (*p) == 84 )
		goto st7;
	goto st0;
st7:
...
st14:
	if ( ++p == pe )
		goto _test_eof14;
case 14:
#line 323 "ext/puma_http11/http11_parser.c"
	if ( (*p) == 10 )
		goto st15;
	goto st0;
st15:
...
st46:
	if ( ++p == pe )
		goto _test_eof46;
case 46:
#line 374 "ext/puma_http11/http11_parser.c"
	goto st0;
tr21:
...
st17:
	if ( ++p == pe )
		goto _test_eof17;
case 17:
#line 390 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 33: goto tr23;
		case 58: goto tr24;
		case 124: goto tr23;
...
st18:
	if ( ++p == pe )
		goto _test_eof18;
case 18:
#line 429 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 13: goto tr26;
		case 32: goto tr27;
		case 127: goto st0;
...
st19:
	if ( ++p == pe )
		goto _test_eof19;
case 19:
#line 449 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 13: goto tr29;
		case 127: goto st0;
	}
...
st20:
	if ( ++p == pe )
		goto _test_eof20;
case 20:
#line 502 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 32: goto tr31;
		case 60: goto st0;
		case 62: goto st0;
...
st21:
	if ( ++p == pe )
		goto _test_eof21;
case 21:
#line 523 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 32: goto tr33;
		case 60: goto st0;
		case 62: goto st0;
...
st23:
	if ( ++p == pe )
		goto _test_eof23;
case 23:
#line 569 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 32: goto tr8;
		case 34: goto st0;
		case 35: goto tr9;
...
st24:
	if ( ++p == pe )
		goto _test_eof24;
case 24:
#line 589 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 32: goto tr37;
		case 34: goto st0;
		case 35: goto tr38;
...
st25:
	if ( ++p == pe )
		goto _test_eof25;
case 25:
#line 612 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 32: goto tr41;
		case 34: goto st0;
		case 35: goto tr42;
...
st26:
	if ( ++p == pe )
		goto _test_eof26;
case 26:
#line 632 "ext/puma_http11/http11_parser.c"
	switch( (*p) ) {
		case 32: goto tr44;
		case 34: goto st0;
		case 35: goto tr45;
...
#line 118 "ext/puma_http11/http11_parser.rl"
